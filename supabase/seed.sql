-- =============================================================
-- Be Fit Gym — Sample data for local development
-- Run via: supabase db reset (executes automatically)
-- =============================================================
...
-- ─── memberships ─────────────────────────────────────────────
INSERT INTO public.memberships (member_id, tier_name, status, start_date, end_date) VALUES
    ('11111111-1111-1111-1111-111111111111', 'VIP',     'active',         NOW() - INTERVAL '5 days',  NOW() + INTERVAL '25 days'),
    ('22222222-2222-2222-2222-222222222222', 'Premium', 'active',         NOW() - INTERVAL '10 days', NOW() + INTERVAL '20 days'),
    ('33333333-3333-3333-3333-333333333333', 'Basic',   'expired',        NOW() - INTERVAL '60 days', NOW() - INTERVAL '30 days'),
    ('44444444-4444-4444-4444-444444444444', 'Premium', 'pending_payment', NULL, NULL),
    ('55555555-5555-5555-5555-555555555555', 'Basic',   'active',         NOW() - INTERVAL '1 days',  NOW() + INTERVAL '29 days');
